...
class restore_qtype_highlightwords_plugin extends restore_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        // Add own qtype stuff.
        $elename = 'highlightwords';

        // We use get_recommended_name() so this works.
        $elepath = $this->get_pathfor('/highlightwords');
    ...
    /**
     * Process the qtype/highlightwords element
     */
    public function process_highlightwords($data) {
        global $DB;
        ...
        if ($questioncreated) {
            ...
            $this->set_mapping('qtype_highlightwords_options', $oldid, $newitemid);
        }
    }
    ...
    public static function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('qtype_highlightwords_options', $fields, 'qtype_highlightwords_options');
     ...
     * http://docs.moodle.org/25/en//question/type/highlightwords#No_Duplicates_Mode 
    ...
    public function process_question_answer($data) {
        ...
        if ($questioncreated) {
            ...
            if (!$newitemid) {
                $params = array('questionid' => $newquestionid);
