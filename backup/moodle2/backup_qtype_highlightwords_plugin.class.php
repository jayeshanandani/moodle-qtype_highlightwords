...
class backup_qtype_highlightwords_plugin extends backup_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        $plugin = $this->get_plugin_element(null, '../../qtype', 'highlightwords');
        ...
        $pluginwrapper->add_child($highlightwords);

        // Set source to populate the data.
        $highlightwords->set_source_table('qtype_highlightwords_options',
